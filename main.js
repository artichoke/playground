...
if (urlParams.has("embed")) {
    ...
    embeddableElement.setAttribute("style", "position: absolute; width: 100%; height: 100%; top:0; left: 0; background-color: white; max-width: 100%");
}
class Interpreter {
    constructor(wasm) {
        this.wasm = wasm;
